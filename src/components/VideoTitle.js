...
const VideoTitle = ({title, description}) => {
  ...
  return (
    <div className="pt-52 px-[68px] w-[100%] absolute z-30 text-white">
      ...
      <div className="flex">
        <button className="flex items-center my-10  py-3 px-8 gap-2 text-black rounded-md font-semibold text-xl bg-white hover:bg-opacity-70">
        ...
        <button className="flex items-center my-10 mx-4 py-3 px-8 gap-2 text-white rounded-md font-semibold text-xl bg-gray-700 bg-opacity-70 hover:bg-opacity-50">
