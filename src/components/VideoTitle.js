...
const VideoTitle = ({title, description}) => {
  ...
  return (
    <div className="pt-64 px-[64px] w-[100%] absolute z-30 text-white">
      ...
      <div className="flex">
        ...
        <button className="flex items-center my-10 mx-4 py-[10px] px-8 gap-2 text-white rounded-md font-semibold text-xl bg-gray-700 bg-opacity-70 hover:bg-opacity-50">
